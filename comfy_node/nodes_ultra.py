"""ULTRA (Krea 2) node, rendering on a remote Modal deployment."""
...
ENV_URL = "ULTRA_MODAL_URL"
CATEGORY = "ULTRA / Krea 2 (Modal)"
...
class UltraModal:
    """Text to image on the remote ULTRA deployment."""
        ...
        return {
            "required": {
                "prompt": (
                    ...
                    {
                        "multiline": True,
                        "default": "a low angle action shot of a cyclist on a rain-slick street at dusk",
                    },
                ),
                "negative_prompt": (
                    "STRING",
    ...
    FUNCTION = "generate"
    CATEGORY = CATEGORY
    DESCRIPTION = "Render with ULTRA (Krea 2) on a Modal-hosted ComfyUI and return the image."
...
NODE_CLASS_MAPPINGS = {"UltraModal": UltraModal}

NODE_DISPLAY_NAME_MAPPINGS = {"UltraModal": "ULTRA / Krea 2 (Modal)"}
