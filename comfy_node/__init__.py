...
from . import nodes_flux2klein, nodes_ideogram4, nodes_ultra, nodes_waiillustrious

NODE_CLASS_MAPPINGS = {
    **nodes_ideogram4.NODE_CLASS_MAPPINGS,
    **nodes_flux2klein.NODE_CLASS_MAPPINGS,
    **nodes_waiillustrious.NODE_CLASS_MAPPINGS,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **nodes_waiillustrious.NODE_DISPLAY_NAME_MAPPINGS,
