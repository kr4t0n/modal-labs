"""RedGPT2 (Krea 2) node, rendering on a remote Modal deployment."""
...
class RedGPT2GPTModal:
    """Text to image on the remote RedGPT2 deployment."""
        ...
        return {
            "required": {
                "prompt": (
                    ...
                    {
                        "multiline": True,
                        "default": "a portrait of a woman reading by a window in late afternoon light",
                    },
                ),
                "negative_prompt": (
                    "STRING",
    ...
    FUNCTION = "generate"
    CATEGORY = CATEGORY
    DESCRIPTION = "Render with RedGPT2 (Krea 2) on a Modal-hosted ComfyUI and return the image."
...
NODE_CLASS_MAPPINGS = {"RedGPT2GPTModal": RedGPT2GPTModal}

NODE_DISPLAY_NAME_MAPPINGS = {"RedGPT2GPTModal": "RedGPT2 GPT / Krea 2 (Modal)"}
