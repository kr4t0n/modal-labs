#!/usr/bin/env python3
"""Command-line client for the deployed Z-Image Turbo (Stable Yogi) endpoint.

export ZIMAGETURBOSTABLEYOGI_MODAL_URL=https://...modal.run
export MODAL_KEY=wk-...  MODAL_SECRET=ws-...

./client.py generate "a harbour at dawn, pastel houses" --aspect-ratio 16:9
...
def main() -> None:
    ...
    gen.add_argument("--shift", type=float, default=workflow.DEFAULT_SHIFT)
