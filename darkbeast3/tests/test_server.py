"""Dark Beast v3's slice of the ASGI layer.
...
@pytest.mark.asyncio
async def test_defaults_endpoint_admits_its_source(wired):
    """The point of this route here: say that nothing upstream published these."""
    _, client, _ = wired
    ...
    assert "template" in body["source"] and "no settings" in body["source"]
