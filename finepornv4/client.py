#!/usr/bin/env python3
"""Command-line client for the deployed FinePorn v4 endpoint.

export FINEPORNV4_MODAL_URL=https://...modal.run
export MODAL_KEY=wk-...  MODAL_SECRET=ws-...

./client.py generate "this is a casual, low-quality photo of ..." --aspect-ratio 3:4
./client.py generate "..." --steps 12 --sampler er_sde --scheduler simple
./client.py defaults
./client.py validate
./client.py health
"""
...
def main() -> None:
    ...
    cli.add_geometry_arguments(
        ...
        default_side=workflow.DEFAULT_SIDE,
        default_megapixels=workflow.DEFAULT_MEGAPIXELS,
    )

    subparsers.add_parser("defaults", help="show the sampler and resolution conventions applied")
