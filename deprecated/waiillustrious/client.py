#!/usr/bin/env python3
"""Command-line client for the deployed WAI-illustrious-SDXL endpoint.

export WAIILLUSTRIOUS_MODAL_URL=https://...modal.run
export MODAL_KEY=wk-...  MODAL_SECRET=ws-...

./client.py generate "1girl, solo, silver hair, masterpiece" --aspect-ratio 2:3
./client.py generate "..." --negative "" --cfg 7 --steps 32
./client.py defaults
./client.py validate
./client.py health
"""
...
def main() -> None:
    ...
    gen.add_argument(
        "--negative",
        default=None,
        help="defaults to the standard Danbooru negative; pass '' to opt out",
    )
    ...
    gen.add_argument("--clip-skip", type=int, default=workflow.DEFAULT_CLIP_SKIP)
