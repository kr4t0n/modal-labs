"""RedGPT2's model-specific slice of the shared ComfyUI service."""
...
SERVICE = ModelService(
    title="RedGPT2 GPT edition (Krea 2) on ComfyUI",
    description="A ComfyUI server with the RedGPT2 Krea 2 finetune, plus a typed generate endpoint.",
