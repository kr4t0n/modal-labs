#!/usr/bin/env python3
"""Command-line client for the deployed ULTRA endpoint.

export ULTRA_MODAL_URL=https://...modal.run
export MODAL_KEY=wk-...  MODAL_SECRET=ws-...

./client.py generate "a cyclist on a rain-slick street at dusk" --aspect-ratio 16:9
