"""ULTRA's model-specific slice of the shared ComfyUI service."""
...
SERVICE = ModelService(
    title="ULTRA (Krea 2) on ComfyUI",
    description="A ComfyUI server with the ULTRA Krea 2 finetune, plus a typed generate endpoint.",
...
def _register_extra_routes(web_app: FastAPI) -> None:
    ...
    async def defaults() -> dict:
        ...
        return {
            ...
            "source": "ComfyUI's official Krea 2 turbo template",
